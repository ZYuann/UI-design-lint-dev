...
CLASS_MAP: Dict[str, Type[SketchObject]] = {
    "triangle": Triangle,
    "textStyle": TextStyle,
    "text": Text,
    "symbolMaster": SymbolMaster,
...
if __name__ == "__main__":
    json_dict = json.load(open(
        '/Users/zhangyuan/Documents/设计稿/python/Test/1.json', 'r')) 
        # ../sketch文件/.cache/洋淘大赏2/pages/ACD24EC7-29B4-4469-834E-04A0331CFDEA.json
    layer = Page.from_dict(json_dict)
    print(layer.class_)
    print(layer)
