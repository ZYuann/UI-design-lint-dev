...
from sketch_utils import AnyLayer, Artboard, Border, Color, Fill, Group, InnerShadow, Page, \
    Shadow, ShapeGroup, SymbolMaster
...
def transform_layer(layer: AnyLayer, xy: Point,
                    transforms: Tuple[Transform, ...] = (),
                    bound_areas: Tuple[BoundArea, ...] = (),
...
__all__ = [
    'recursive_remove_layer', 'Rotation', 'Scale', 'Transform', 'BoundArea', 'LayerTransformed', 'transform_layer',
    'get_polygon_exterior'
]
